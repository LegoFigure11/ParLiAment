namespace ParLiAment.WinForms;
    ...
    private void InitializeComponent()
    {
        ...
        TB_GroupSeedResult = new TextBox();
        B_CalculateGroupSeed = new Button();
        TB_File2 = new TextBox();
        B_File2 = new Button();
        TB_File1 = new TextBox();
        B_File1 = new Button();
        ...
        TP_GroupSeedSolver.SuspendLayout();
        ...
        TP_Static.Size = new Size(380, 309);
        ...
        TP_GroupSeedSolver.Controls.Add(TB_GroupSeedResult);
        TP_GroupSeedSolver.Controls.Add(B_CalculateGroupSeed);
        TP_GroupSeedSolver.Controls.Add(TB_File2);
        TP_GroupSeedSolver.Controls.Add(B_File2);
        TP_GroupSeedSolver.Controls.Add(TB_File1);
        TP_GroupSeedSolver.Controls.Add(B_File1);
        TP_GroupSeedSolver.Location = new Point(4, 24);
        TP_GroupSeedSolver.Name = "TP_GroupSeedSolver";
        TP_GroupSeedSolver.Size = new Size(380, 309);
        ...
        // 
        LL_SeedSolverAttribution.AutoSize = true;
        ...
        // 
        // L_SeedSolverAttribution
        // 
        L_SeedSolverAttribution.AutoSize = true;
        L_SeedSolverAttribution.Location = new Point(3, 276);
        L_SeedSolverAttribution.Name = "L_SeedSolverAttribution";
        L_SeedSolverAttribution.Size = new Size(202, 15);
        L_SeedSolverAttribution.TabIndex = 14;
        L_SeedSolverAttribution.Text = "Group Seed Solver logic by Lusamine";
        // 
        // L_GroupSeedResult
        // 
        L_GroupSeedResult.AutoSize = true;
        L_GroupSeedResult.Location = new Point(7, 124);
        L_GroupSeedResult.Name = "L_GroupSeedResult";
        L_GroupSeedResult.Size = new Size(71, 15);
        L_GroupSeedResult.TabIndex = 13;
        L_GroupSeedResult.Text = "Group Seed:";
        // 
        // TB_GroupSeedResult
        // 
        TB_GroupSeedResult.CharacterCasing = CharacterCasing.Upper;
        TB_GroupSeedResult.Font = new Font("Consolas", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
        TB_GroupSeedResult.Location = new Point(84, 122);
        TB_GroupSeedResult.MaxLength = 16;
        ...
        // TB_File2
        // 
        TB_File2.Location = new Point(84, 37);
        TB_File2.Name = "TB_File2";
        ...
        // TB_File1
        // 
        TB_File1.Location = new Point(84, 12);
        TB_File1.Name = "TB_File1";
        ...
        // B_File1
        // 
        B_File1.Location = new Point(3, 11);
        B_File1.Name = "B_File1";
        B_File1.Size = new Size(75, 25);
        B_File1.TabIndex = 0;
        B_File1.Text = "File 1";
        B_File1.UseVisualStyleBackColor = true;
        B_File1.Click += B_File1_Click;
        // 
        ...
        NUD_BabyModeDelay.Location = new Point(69, 40);
        ...
        L_BabyMode.Location = new Point(6, 15);
        ...
        TP_GroupSeedSolver.ResumeLayout(false);
        TP_GroupSeedSolver.PerformLayout();
    ...
    private Button B_File2;
    private Button B_CalculateGroupSeed;
    private Label L_GroupSeedResult;
    public TextBox TB_GroupSeedResult;
    private LinkLabel LL_SeedSolverAttribution;
    private Label L_SeedSolverAttribution;
